...
$$ {PE}_{\left(p,2j\right)}=sin{\ \left(\ \frac{p}{{10000}^\sfrac{2j}{d}}\right)} $$

$$ {PE}_{(p,2j+1)}=cos{\left(\ \frac{p}{{10000}^\sfrac{2j}{d}}\right)}	 $$                                     
 (EQ6)a
 
 〖PE〗_((p,2j))=sin⁡〖 ( p/10000^(2j⁄d) )〗
 〖PE〗_((p,2j+1))=cos⁡( p/10000^(2j⁄d) )	  
